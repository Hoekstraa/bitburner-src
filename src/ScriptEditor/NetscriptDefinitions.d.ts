...
export interface NS {
  ...
  /**
   * Get the time of modification of a file.
   * @remarks
   * RAM cost: 0 GB
   *
   * This function is used to read the time of modification metadata
   * from a text file (.txt) or script (.js or .script).
   *
   * The time is denoted in Unix epoch ms time.
   *
   ...
   * @Returns The time of modification as a number.
   */
   timeOfModification(filename: string): number;
